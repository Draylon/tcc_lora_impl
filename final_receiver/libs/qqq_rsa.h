...
uint8_t rsa_encrypt_raw(const uint8_t* modulus, uint8_t* msg_enc);
...
uint8_t rsa_encrypt_pkcs(const uint8_t* modulus, uint8_t* msg, uint8_t msglen, uint8_t* rnd_enc);

uint8_t bin2hex(char* string, uint8_t *bin, uint8_t binlen);
